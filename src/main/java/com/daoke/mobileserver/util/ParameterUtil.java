...
public class ParameterUtil {
     ...
     * @return
     */
    public static String getDaokeSignData(Map<String, String> params) {
     ...
     * @return
     */
    public static String getHuaFeiDuoSignData(Map<String, String> params) {
        StringBuffer content = new StringBuffer();
        ...
        for (int i = 0; i < keys.size(); i++) {
            String key = (String) keys.get(i);
            if ("sign".equals(key)||"mod".equals(key)) {
                continue;
            }
            String value = (String) params.get(key);
